...
from src.modules.vehicles.application.vehicle_export_service import (
...
from src.modules.vehicles.application.vehicle_management_service import (
    create_vehicle_record,
    delete_vehicle_record,
    update_vehicle_record,
)
from src.modules.vehicles.application.vehicle_service import (
...
from src.modules.vehicles.application.vehicle_service import get_vehicle_detail_data
from src.forms.vehicle_forms import VehicleCreateForm, VehicleEditForm
from src.core.extensions import db
from src.modules.vehicles.domain.models import Department, User, Vehicle
