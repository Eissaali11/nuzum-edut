...
from src.modules.vehicles.domain.models import Vehicle, VehiclePeriodicInspection, VehicleSafetyCheck
from src.utils.vehicle_helpers import log_audit
from src.utils.vehicle_route_helpers import format_date_arabic, save_image
