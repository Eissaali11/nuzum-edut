...
from src.domain.employees.models import Department, Employee, employee_departments
from src.modules.vehicles.application.vehicle_service import (
    get_vehicle_current_employee_id,
    update_all_vehicle_drivers,
)
from src.modules.vehicles.domain.models import Vehicle, VehicleHandover
