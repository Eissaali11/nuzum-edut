...
from src.core.extensions import db, csrf
from src.modules.vehicles.domain.models import Vehicle, VehicleHandover, VehicleHandoverImage
from src.domain.employees.models import Employee, Department
from src.modules.vehicles.application.services import get_vehicle_handover_context, create_vehicle_handover_action
from src.infrastructure.storage import save_base64_image, save_uploaded_file
...
from src.utils.vehicle_route_helpers import save_file, update_vehicle_state, format_date_arabic
