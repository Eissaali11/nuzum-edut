...
def get_vehicles_blueprint():
    ...
    # 1. Handover Routes
    try:
        from src.modules.vehicles.presentation.web.handover_routes import register_handover_routes
    ...
    # 2. Workshop Routes
    try:
        from src.modules.vehicles.presentation.web.workshop_routes import register_workshop_routes
    ...
    # 3. Accident Routes
    try:
        from src.modules.vehicles.presentation.web.accident_routes import register_accident_routes
    ...
    try:
        from src.modules.vehicles.presentation.web.vehicle_routes import register_vehicle_routes
    ...
    try:
        from src.modules.vehicles.presentation.web.vehicle_extra_routes import register_vehicle_extra_routes
