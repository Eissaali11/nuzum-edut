...
from src.modules.vehicles.presentation.web.vehicle_extra_authorization_routes import (
    register_vehicle_extra_authorization_routes,
)
from src.modules.vehicles.presentation.web.vehicle_extra_core_routes import (
    register_vehicle_extra_core_routes,
)
from src.modules.vehicles.presentation.web.vehicle_extra_document_misc_routes import (
    register_vehicle_extra_document_misc_routes,
)
from src.modules.vehicles.presentation.web.vehicle_extra_handover_drive_routes import (
    register_vehicle_extra_handover_drive_routes,
)
from src.modules.vehicles.presentation.web.vehicle_extra_inspection_safety_routes import (
