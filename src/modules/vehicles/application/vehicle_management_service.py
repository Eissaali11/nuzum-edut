...
from src.modules.vehicles.domain.models import Vehicle, VehicleHandover, VehicleWorkshop
from src.modules.vehicles.domain.models import ExternalAuthorization, VehicleExternalSafetyCheck
from src.modules.vehicles.domain import VehicleMaintenance
from src.modules.operations.domain.models import OperationNotification, OperationRequest
