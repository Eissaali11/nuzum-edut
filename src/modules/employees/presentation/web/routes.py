...
from src.utils.permissions_service import can_edit, can_delete
from src.utils.user_helpers import require_module_access
from src.modules.employees.application.core import (
...
@require_module_access(Module.EMPLOYEES, Permission.CREATE)
def import_excel():
    from src.routes.hr.employees import import_excel as legacy_import
...
@require_module_access(Module.EMPLOYEES, Permission.VIEW)
def export_excel():
    from src.routes.hr.employees import export_excel as legacy_export
...
def export_comprehensive():
    from src.routes.hr.employees import export_comprehensive as legacy_export
    return legacy_export()
