...
# بينما يقوم models.py بالاستيراد باستخدام `from src.core.extensions import db`
...
from src.core.api_v2_security import init_rate_limiter, register_api_v2_guard
# ... استيراد مكتبات أخرى ...
...
from src.routes.database_backup import database_backup_bp
...
from src.core.error_handlers import init_error_handlers
...
from src.core.database_config import init_db_config
init_db_config(app)
...
from src.core.jinja_filters import init_filters
from src.core.context_processors import init_context_processors
...
def root():
    ...
    from src.models import Module, UserRole 
...
with app.app_context():
    ...
    from src.routes.blueprint_registry import register_all_blueprints
    ...
    from src.utils.user_helpers import get_role_display_name, get_module_display_name, format_permissions, check_module_access
    
    # تسجيل فلاتر تشفير المعرفات للروابط الآمنة
    from src.utils.id_encoder import register_template_filters
