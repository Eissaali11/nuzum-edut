...
from src.routes.core import core_blueprints
from src.routes.hr import hr_blueprints
from src.routes.attendance import attendance_blueprints
from src.routes.analytics import analytics_blueprints
