...
from src.modules.employees.application.core import (create_employee, update_employee, delete_employee, 
...
from src.modules.employees.application.tracking import (get_tracking_page_data, get_tracking_dashboard_data, 
    get_track_history_page_data)
from src.modules.employees.application.io import (process_employee_import, generate_sample_import_template,
...
from src.modules.employees.application.report_service import (export_basic_report_pdf, export_comprehensive_report_pdf,
...
from src.modules.employees.application.messages import translate_service_message
from src.routes.employees_helpers import (handle_unlink_flash, extract_department_id_from_url,
...
def index():
    ...
    try:
        limit_value = int(os.environ.get('EMPLOYEES_PAGE_LIMIT', '80'))
    except Exception:
        limit_value = 80
