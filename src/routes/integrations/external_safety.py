...
import resend
from src.routes.integrations.external_safety_helpers import (
    create_safety_check_notification as _create_safety_check_notification,
    create_safety_check_review_notification as _create_safety_check_review_notification,
    get_all_current_drivers_with_email as _get_all_current_drivers_with_email,
    get_all_current_drivers as _get_all_current_drivers,
...
def create_safety_check_notification(user_id, vehicle_plate, supervisor_name, check_status, check_id):
    return _create_safety_check_notification(user_id, vehicle_plate, supervisor_name, check_status, check_id)

def create_safety_check_review_notification(user_id, vehicle_plate, action, reviewer_name, check_id):
    return _create_safety_check_review_notification(user_id, vehicle_plate, action, reviewer_name, check_id)
...
def get_all_current_driversWithEmil():
    return _get_all_current_drivers_with_email()
...
def get_all_current_drivers():
    return _get_all_current_drivers()
...
def compress_image(image_path, max_size=1200, quality=85):
    return _compress_image(image_path, max_size=max_size, quality=quality)
