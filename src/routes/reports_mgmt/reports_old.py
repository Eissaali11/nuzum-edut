...
from src.utils.pdf import create_pdf, arabic_text, create_data_table, get_styles
...
from src.utils.date_converter import parse_date, format_date_hijri, format_date_gregorian, get_month_name_ar
from src.utils.excel import generate_employee_excel, generate_salary_excel
from src.utils.vehicles_export import export_vehicle_pdf, export_vehicle_excel
from src.utils.pdf_generator import generate_salary_report_pdf
...
def employees_pdf():
    ...
    from src.utils.pdf import arabic_text, create_pdf, create_data_table, get_styles
    from reportlab.lib.units import cm
...
def documents_excel():
    ...
    from src.utils.excel_utils import adjust_column_width
