...
def departments_circles_overview():
    ...
    from src.routes._attendance_main import departments_circles_overview as original_func
...
def circle_accessed_details(department_id, circle_name):
    ...
    # Temporary: redirect to original implementation
    from src.routes._attendance_main import circle_accessed_details as original_func
...
def export_circle_access_excel(department_id, circle_name):
    ...
    # Temporary: redirect to original implementation
    from src.routes._attendance_main import export_circle_access_excel as original_func
    return original_func(department_id, circle_name)
...
def mark_circle_employees_attendance(department_id, circle_name):
    ...
    # Temporary: redirect to original implementation
    from src.routes._attendance_main import mark_circle_employees_attendance as original_func
    return original_func(department_id, circle_name)
