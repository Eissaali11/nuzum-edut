...
def _register_blueprints(app):
    ...
    from src.presentation.web.routes import web_bp
    from src.presentation.web.api_routes import api_bp
    from src.presentation.web.auth_routes import auth_bp
    from src.presentation.web.employees import employees_bp as employees_web_bp
    from src.modules.employees.presentation.web.routes import employees_bp as employees_module_bp
    from src.presentation.web.vehicles import vehicles_web_bp
...
def _register_legacy_blueprints(app):
    ...
    # جعل "from src.core.extensions import db" يعمل دون تحميل app.py (لتجنب 404 عند استيراد المسارات)
    class _AppStub:
        pass
    _stub = _AppStub()
    _stub.db = db
    ...
    try:
        ...
        pass
    try:
        from src.routes.attendance_admin import attendance_admin_bp
    ...
    try:
        ...
        from src.core.extensions import csrf
    ...
    try:
        ...
        pass
    try:
        from src.presentation.api.v1 import api_v1
