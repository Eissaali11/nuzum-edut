...
from src.utils.user_helpers import get_role_display_name, get_module_display_name, format_permissions
...
def init_context_processors(app, csrf):
    ...
    def inject_permissions():
        ...
        from src.utils.permissions_service import get_permissions_context
