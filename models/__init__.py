...
This package re-exports all domain models from their respective modules to maintain
...
from .fleet import VehicleInsurance
from .hr import Contract
...
__all__ = [
    ...
    # Domain aliases requested in phase 5
    'VehicleInsurance', 'Contract', 'Request',
]
