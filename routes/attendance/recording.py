...
- لا يتم تسجيل المسارات إلا عند استدعاء register_recording_routes().
"""
...
def register_recording_routes(attendance_bp):
    """Register attendance recording routes on the provided blueprint."""
    ...
    def all_departments_attendance():
        ...
        # الحصول على جميع الأقسام مع عدد الموظفين النشطين
        try:
            departments = []
    ...
    return {
        ...
        'all_departments_attendance': all_departments_attendance,
        'department_bulk_attendance': department_bulk_attendance,
    }
