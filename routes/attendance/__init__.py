...
def _initialize_attendance_bp():
        ...
        if modular_mode == '1':
                try:
                        ...
                        print(f"[ERR] Phase 1 failed: {e}, attempting Phase 2 fallback")
        ...
        if modular_mode == '0':
                try:
                        ...
                        print(f"[ERR] Legacy load failed: {e}, attempting Phase 2 fallback")
        
        try:
                _attendance_bp_cache = _build_modular_blueprint_v2()
                print("[OK] Attendance Module: Using Phase 2 (modular structure)")
                return _attendance_bp_cache
        except Exception as e:
