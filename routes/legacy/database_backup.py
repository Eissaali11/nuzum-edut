...
TABLE_ARABIC_NAMES = {
    ...
    'vehicle': 'المركبات',
    'vehicle_handover': 'تسليم المركبات',
    'vehicle_handover_image': 'صور تسليم المركبات',
    'vehicle_workshop': 'ورشة المركبات',
    'vehicle_workshop_image': 'صور ورشة المركبات',
    'vehicle_accident': 'حوادث المركبات',
    'vehicle_accident_images': 'صور حوادث المركبات',
    'vehicle_external_safety_check': 'فحص السلامة الخارجي',
    'vehicle_safety_image': 'صور السلامة',
    'vehicle_safety_check': 'فحص سلامة المركبات',
    'vehicle_checklist': 'قائمة فحص المركبات',
    'vehicle_checklist_image': 'صور قائمة الفحص',
    'vehicle_checklist_item': 'بنود قائمة الفحص',
    'vehicle_damage_marker': 'علامات أضرار المركبات',
    'vehicle_fuel_consumption': 'استهلاك الوقود',
    'vehicle_inspection_images': 'صور فحص المركبات',
    'vehicle_inspection_records': 'سجلات فحص المركبات',
    'vehicle_maintenance': 'صيانة المركبات',
    'vehicle_maintenance_image': 'صور صيانة المركبات',
    'vehicle_periodic_inspection': 'الفحص الدوري للمركبات',
    'vehicle_project': 'مشاريع المركبات',
    'vehicle_rental': 'تأجير المركبات',
    'vehicle_user_access': 'صلاحيات مستخدمي المركبات',
    'document': 'المستندات',
    'user': 'المستخدمون',
    'user_accessible_departments': 'أقسام المستخدم المتاحة',
    'user_permission': 'صلاحيات المستخدمين',
    'salary': 'الرواتب',
    'employee_requests': 'طلبات الموظفين',
    'employee_departments': 'أقسام الموظفين',
    'employee_geofences': 'نطاقات الموظفين الجغرافية',
    'employee_liabilities': 'التزامات الموظفين',
    'employee_locations': 'مواقع الموظفين',
    'employee_location': 'موقع الموظف',
    'mobile_devices': 'الأجهزة المحمولة',
    'device_assignments': 'تعيينات الأجهزة',
    'rental_properties': 'العقارات المؤجرة',
    'property_payments': 'مدفوعات العقارات',
    'property_images': 'صور العقارات',
    'property_furnishings': 'مفروشات العقارات',
    'property_employees': 'موظفو العقارات',
    'geofences': 'النطاقات الجغرافية',
    'geofence_sessions': 'جلسات النطاق الجغرافي',
    'geofence_events': 'أحداث النطاق الجغرافي',
    'geofence_attendance': 'حضور النطاق الجغرافي',
    'sim_cards': 'شرائح الاتصال',
    'voicehub_calls': 'مكالمات VoiceHub',
    'voicehub_analysis': 'تحليلات المكالمات',
    'system_audit': 'سجل النظام',
    'audit_log': 'سجل المراجعة',
    'audit_logs': 'سجلات المراجعة',
    'nationality': 'الجنسيات',
    'nationalities': 'الجنسيات',
    'accounting_account': 'الحسابات المالية',
    'accounting_journal_entry': 'القيود المحاسبية',
    'accounting_journal_line': 'بنود القيود',
    'accounting_cost_center': 'مراكز التكلفة',
    'accounting_fiscal_year': 'السنة المالية',
    'accounting_fiscal_period': 'الفترات المالية',
    'accounting_dimension': 'الأبعاد المحاسبية',
    'accounting_dimension_value': 'قيم الأبعاد',
    'accounting_budget': 'الميزانيات',
    'accounting_budget_line': 'بنود الميزانية',
    ...
    'car_wash_requests': 'طلبات غسيل السيارات',
    'car_wash_media': 'وسائط غسيل السيارات',
    'car_inspection': 'فحص السيارات',
    'car_inspection_requests': 'طلبات فحص السيارات',
    'car_inspection_media': 'وسائط فحص السيارات',
    'advance_payment': 'السلف',
    'advance_payment_requests': 'طلبات السلف',
    'invoice': 'الفواتير',
    'invoice_requests': 'طلبات الفواتير',
    'e_invoices': 'الفواتير الإلكترونية',
    'e_invoice_line_items': 'بنود الفواتير الإلكترونية',
    'e_invoice_audit': 'مراجعة الفواتير الإلكترونية',
    'notification': 'الإشعارات',
    'notifications': 'الإشعارات',
    'operation_notifications': 'إشعارات العمليات',
    'operation_requests': 'طلبات العمليات',
    'request_notifications': 'إشعارات الطلبات',
    'fleet_metrics': 'مؤشرات الأسطول',
    'project': 'المشاريع',
    'customers': 'العملاء',
    'vendors': 'الموردون',
    'fee': 'الرسوم',
    'fees': 'الرسوم',
    'fees_cost': 'تكاليف الرسوم',
    'fees_costs': 'تكاليف الرسوم',
    'renewal_fee': 'رسوم التجديد',
    'renewal_fees': 'رسوم التجديد',
    'bank_transfer_files': 'ملفات التحويل البنكي',
    'external_authorization': 'التفويضات الخارجية',
    'imported_phone_numbers': 'أرقام الهواتف المستوردة',
    'inspection_upload_tokens': 'رموز رفع الفحص',
    'leave_balances': 'أرصدة الإجازات',
    'leave_requests': 'طلبات الإجازات',
    'liability_installments': 'أقساط الالتزامات',
...
def backup_page():
    ...
    return render_template('backup/index.html',
                          ...
                          table_arabic_names=TABLE_ARABIC_NAMES)
