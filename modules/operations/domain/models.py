...
class OperationRequest(db.Model):
    ...
    def get_related_record(self):
        ...
        if self.operation_type == "handover":
            from modules.vehicles.domain.models import VehicleHandover
