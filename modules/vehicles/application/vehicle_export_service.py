...
from modules.vehicles.domain.models import Vehicle, VehicleProject, VehicleRental, VehicleWorkshop
...
from utils.vehicles_export import export_vehicle_excel, export_vehicle_pdf
